			...
			<div class="content-error">
				<div class="hpanel">
                    <div class="panel-body">
                        <form id="loginForm" role="form" method="POST" action="{{ url ('/formateur/login') }}"> {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-success btn-block loginbtn" href="/formateur/register">Créer un Compte</a>
                            </div>
                        </form>
                    </div>
                </div>
