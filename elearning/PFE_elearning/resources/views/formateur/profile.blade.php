                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="profile-info-inner">
                            <div class="row">
                                <center> <img src="{{url('img/user.png')}}"> </center>
                            </div>
                            <div class="profile-details-hr">
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr">
                                            <p><b>Nom & Prénom</b><br />{{$user->name}}</p>@csrf
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Spécialité</b><br /> {{$user->specialite}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                        <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                            <p><b>Téléphone</b><br /> {{$user->phone}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="address-hr">
                                            <p><b>Diplome</b><br />{{$user->diplome}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div class="address-hr">
                                            <a href="#"><img src="{{url('img/achievement.png')}}"></a>
                                            <h3>500</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div class="address-hr">
                                            <a href="#"><img src="{{url('img/elearning.png')}}"></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                        <div class="address-hr">
                                            <a href="#"><img src="{{url('img/student.png')}}"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Mes Cours</a></li>
                            </ul>
                                            ...
                                            <div class="review-content-section">
                                                <div class="chat-discussion" style="height: auto">
                                                    ...
                                                    <div class="chat-message">
                                                        ...
                                                        <div class="message">
                                                            <a class="message-author" href="#"> {{$courses->name_cours}} </a>
                                                            <span class="message-date">  {{$courses->created_at}} </span>
                                                            <span class="message-content">{{$courses->description_cours}}</span>
                                                            <div class="m-t-md mg-t-10">
                                                                <div class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i>Nombre des commentaires</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endforeach
