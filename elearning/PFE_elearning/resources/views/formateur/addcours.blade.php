...
<body>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Courses" href="listCours"><span class="mini-sub-pro">Liste Des Cours</span></a></li>
                                <li><a title="Add Courses" href="addCours"><span class="mini-sub-pro">Ajouter Cours</span></a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form id="add-department" method="post" action="/formateur/createCours" class="add-department" enctype="multipart/form-data">{{ csrf_field () }}
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="name_cours" type="text" class="form-control" placeholder="Nom du Cours">
                                                                @if ($errors->has('name_cours'))

                                                                    <span class="text-danger">{{ $errors->first('name_cours') }}</span>

                                                                @endif
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="specialite_cours" type="text" class="form-control" placeholder="Specialite du Cours">
                                                                @if ($errors->has('specialite_cours'))

                                                                    <span class="text-danger">{{ $errors->first('specialite_cours') }}</span>

                                                                @endif
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="date_cours" type="text" class="form-control" placeholder="Date_Cours">
                                                                @if ($errors->has('date_cours'))

                                                                    <span class="text-danger">{{ $errors->first('date_cours') }}</span>

                                                                @endif
                                                            </div>
                                                            <div class="form-group">
                                                                <input id="content_cours" name="content_cours" type="file" class="form-control">
                                                            </div>
                                                        </div>

                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <textarea name="description_cours" placeholder="Description"></textarea>
                                                                @if ($errors->has('description_cours'))

                                                                    <span class="text-danger">{{ $errors->first('description_cours') }}</span>
    ...
    <script src="{{url('js/masking-active.js')}}"></script>
    <!-- datepicker JS
		============================================ -->
    <script src="{{url('js/datepicker/jquery-ui.min.js')}}"></script>
