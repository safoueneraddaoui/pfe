...
<body>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a title="Landing Page" href="index" aria-expanded="false"><span class="educate-icon educate-home icon-wrap" aria-hidden="true"></span> <span class="mini-click-non">Index</span></a>
                        </li>
                        <li>
                            <a class="has-arrow" href="all-professors.html" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Formateurs</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="listformateur"><span class="mini-sub-pro">Liste Formateurs</span></a></li>
                                <li><a title="Add Professor" href="addformateur"><span class="mini-sub-pro">Ajouter Formateur</span></a></li>
                                <li><a title="Edit Professor" href="editformateur"><span class="mini-sub-pro">Modifier Formateur</span></a></li>
                                <li><a title="Professor Profile" href="deleteformateur"><span class="mini-sub-pro">Supprimer Formateur</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="all-students.html" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Apprenants</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="listapprenant"><span class="mini-sub-pro">Liste Apprenants</span></a></li>
                                <li><a title="Add Students" href="addapprenant"><span class="mini-sub-pro">Ajouter Apprenant</span></a></li>
                                <li><a title="Edit Students" href="editapprenant"><span class="mini-sub-pro">Modifier Apprenant</span></a></li>
                                <li><a title="Students Profile" href="deleteapprenant"><span class="mini-sub-pro">Supprimer Apprenant</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="listCours" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">Courses</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Courses" href="listCours"><span class="mini-sub-pro">All Courses</span></a></li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="changepassword"><span class="edu-icon edu-settings author-log-ic"></span>Mot De Passe</a>
                                                        </li>
                                                        <li><a href="{{('/logout')}}"
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Formateurs <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="listformateur">Liste Formateurs</a>
                                                </li>
                                                <li><a href="addformateur">Ajouter Formateur</a>
                                                </li>
                                                <li><a href="editformateur">Modifier Formateur</a>
                                                </li>
                                                <li><a href="deleteformateur">Supprimer Formateur</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Ajouter Formateur</a></li>
                            </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form method="post" action="/admin/storeformateur"> {{ csrf_field () }}
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="name" type="text" class="form-control" placeholder="Nom & Prénom">
                                                                @if ($errors->has('name'))
                                                            ...
                                                            <div class="form-group">
                                                                <input name="specialite" type="text" class="form-control" placeholder="Spécialite">
                                                            ...
                                                            <div class="form-group">
                                                                <input name="diplome" type="text" class="form-control" placeholder="Diplome">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-group">
                                                                <input name="password" type="passwoed" class="form-control" placeholder="Mot De Passe">
    ...
    <!-- form validate JS
		============================================ -->
    <script src="{{url('js/form-validation/jquery.form.min.js')}}"></script>
    <script src="{{url('js/form-validation/jquery.validate.min.js')}}"></script>
    <script src="{{url('js/form-validation/form-active.js')}}"></script>
    <!-- tab JS
		============================================ -->
