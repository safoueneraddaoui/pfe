...
<body>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="all-professors.html" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Formateur</span></a>
                        ...
                        <li>
                            <a class="has-arrow" href="listapprenant" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Apprenants</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Add Courses" href="addCours"><span class="mini-sub-pro">Add Course</span></a></li>
                        ...
                        <li>
                            <a href="/forums" aria-expanded="false"><span class="educate-icon educate-message icon-wrap"></span> <span class="mini-click-non">Forum</span></a>
                        </li>
                        <li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Formateur <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                            ...
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-edu-rate">
                                        <h3>Nombre des Admins</h3>
                                    </div>
                                </div>
                                <div class="income-range">
                                    <span class="income-percentange bg-green"><span class="counter">1</span>
                                    </span>
                                </div>
                                <div class="clear"></div>
                            </div>
                        ...
                        <div class="income-dashone-total">
                            <div class="income-dashone-pro">
                                ...
                                <div class="income-range order-cl">
                                    <span class="income-percentange bg-red"><span class="counter"> {{$nbr}} </span>
                                    </span>
                                </div>
                                <div class="clear"></div>
                            </div>
                        ...
                        <div class="income-dashone-total res-mg-t-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <div class="income-dashone-pro">
                                ...
                                <div class="income-range visitor-cl">
                                    <span class="income-percentange bg-blue"><span class="counter">{{$nb}}</span>
                                    </span>
                                </div>
                                <div class="clear"></div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="income-dashone-total res-mg-t-30 dk-res-t-pro-30">
                            <div class="income-dashone-pro">
                                <div class="income-rate-total">
                                    <div class="price-edu-rate">
                                        <h3>Nombre des Tests</h3>
                                    </div>
                                </div>
                                <div class="income-range low-value-cl">
                                    <p>In first month</p>
                                    <span class="income-percentange bg-purple"><span class="counter">35</span>
                                    </span>
                                </div>
                                <div class="clear"></div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="social-media-edu">
                            ...
                            <div class="social-edu-ctn">
                                <h3>Likes</h3>
                                <a href="https://www.facebook.com/Safoueneraddaoui.tkd">Page FaceBook</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
    ...
    <script src="{{url('js/chart/peity-active.js')}}"></script>
    <!-- calendar JS
		============================================ -->
