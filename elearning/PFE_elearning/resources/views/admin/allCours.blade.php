                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <form role="search" class="sr-input-func" action="search">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="courses-inner res-mg-b-30">
                            <div class="courses-title">
                                <a href=""><img src="{{url('img/courses/4.jpg')}}" alt=""></a>
                                <h2>{{ $cours->name_cours}}</h2>
                            </div>
                            <div class="course-des">
                                <p><span><i class="fa fa-clock"></i></span> <b>Domaine:</b> {{ $cours->specialite_cours}}</p>
                                <p><span><i class="fa fa-clock"></i></span> <b>Formateur:</b> {{$cours->formateur_name}}</p>
                                <p><span><i class="fa fa-clock"></i></span> <b>Date:</b> {{ $cours->date_cours}}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
