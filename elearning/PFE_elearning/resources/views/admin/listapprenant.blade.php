                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demopro" href="#">Apprenants <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demopro" class="collapse dropdown-header-top">
                                                <li><a href="liste">liste Apprenants</a>
                                                </li>
                                                <li><a href="addapprenant">Add Apprenant</a>
                                                </li>
                                                <li><a href="editapprenat">Edit Apprenant</a>
                                                </li>
                                                <li><a href="deleteapprenant">Student Apprenant</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            ...
                            <div class="add-product">
                                <a href="addapprenant">Ajouter Apprenant</a>
                            </div>
