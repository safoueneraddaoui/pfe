            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="/admin/showstudent" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Students</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="/admin/showstudent"><span class="mini-sub-pro">All Students</span></a></li>
                                <li><a title="Add Students" href="/admin/addstudent"><span class="mini-sub-pro">Add Student</span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Professors <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="/admin/addformateur">Add Professor</a>
                                                </li>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <img alt="logo" class="img-circle m-b" src="{{url('img/contact/professor.png')}}">
                                <h3><a href="">{{ $user->name}}</a></h3>
                                <p class="all-pro-ad">Specialite:{{ $user->specialite}}</p>
                                <p class="all-pro-ad">Diplome:{{ $user->diplome}}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
