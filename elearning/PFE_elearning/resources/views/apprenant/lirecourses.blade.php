                        ...
                        <div class="blog-details-inner">
                                    ...
                                    <div class="latest-blog-single blog-single-full-view">
                                        ...
                                        <div class="blog-details blog-sig-details">
                                            <div class="details-blog-dt blog-sig-details-dt courses-info mobile-sm-d-n">
                                                <span><a href="#"><i class="fa fa-user"></i> <b>Nom Du cours:</b>{{$cours->name_cours}}</a></span>
                                                <span><a href="#"><i class="fa fa-heart"></i> <b>Spécialité cours</b> {{$cours->specialite_cours}}</a></span>
                                                <span><a href="#"><i class="fa fa-comments-o"></i> <b>Date du cours</b> {{$cours->date_cours}} </a></span>
                                            </div>
                                            ...
                                            <div class="comment-details">
                                                <h4><b>{{$comments->user_name}}</b> {{$comments->created_at}} </h4>
                                                <p>S{{$comments->body}} </p>
                                            </div>
                                            @endforeach
                                        </div>
                            ...
                            <div class="row">
                                <div class="coment-area">
                                    <form method="post" action="/apprenant/lirecours/{{$cours->id}}"> @csrf @method('POST')
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <textarea name="body" cols="30" rows="10" placeholder="Ajouter Votre Commentaire"></textarea>
                                            </div>
                                            <div class="payment-adress comment-stn">
                                                <button type="submit" class="btn btn-primary waves-effect waves-light" value="Add Comment">Send</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
