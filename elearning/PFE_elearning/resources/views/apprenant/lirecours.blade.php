                        ...
                        <div class="blog-details-inner">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="latest-blog-single blog-single-full-view">
                                        <div class="blog-image">
                                            <video height="300" width="1080" controls><source src="/storage/{{ $cours->content_cours}}" type='video/mp4'> </video>
                                        </div>
                                        <div class="blog-details blog-sig-details">
                                            <div class="details-blog-dt blog-sig-details-dt courses-info mobile-sm-d-n">
                                                <span><a href="#"><i class="fa fa-user"></i> <b>Cours:</b> Web Development</a></span>
                                                <span><a href="#"><i class="fa fa-heart"></i> <b>Date du Cours:</b> $3000</a></span>
                                                <span><a href="#"><i class="fa fa-comments-o"></i> <b>Nom du Formateur:</b> Alva Adition</a></span>
                                            </div>
                                            <h1><a class="blog-ht" href="#">Description:</a></h1>
                                            <p>vous trovez ici la description</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="user-comment user-coment2">
                                        ...
                                        <div class="comment-details">
                                            <h4>J <span class="comment-replay">Replay</span></h4>
                                            <p> contenut du commentaire<span class="mobile-sm-d-n">ethical four loko. Meggings blog chambray tofu pour-over. Pour-over Tumblr keffiyeh, cornhole whatever cardigan Tonx lomo.Shabby.</span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="coment-area">
                                    <form methode="POST" action="/apprenant/lirecours/{{$cours->id}}"  >
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="form-group">
                                                <textarea name="body" cols="30" rows="10" placeholder=" Commentaire"></textarea>
                                            </div>
