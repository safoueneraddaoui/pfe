                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Courses" href="allCours"><span class="mini-sub-pro">All Courses</span></a></li>
                        ...
                        <li>
                            <a  href="/forums"><span class="educate-icon educate-message icon-wrap"></span> <span class="mini-click-non">Forum</span></a>
                                        ...
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    <i class="glyphicon glyphicon-globe" aria-hidden="true">{{Auth::user()->notifications->count()}}</i></a>
                            ...
                            <div class="asset-inner">
                                <table>
                                    <tr>
                                        ...
                                        <th>Spécialite</th>
                                        <th>Date du Cours</th>
                                        <th>Accéder au Cours</th>
                                    </tr>
                                    @foreach($cours as $cours)
                                    <tr>
                                        <td>{{$cours->name_cours}}</td>
                                        <td>{{$cours->specialite_cours}}</td>
                                        <td>{{$cours->date_cours}}</td>
                                        <td>
                                            <a class="pd-setting" href="/apprenant/lirecours/{{$cours->id}}" >
                                                Lire
                                            </a>
                                        </td>
                                    </tr>
