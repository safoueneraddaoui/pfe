    ...
    */
    ...
    public function login(Request $request)
    {
      ...
      $request->validate(
        ...
        {
          $data=$request->input();
           if (Auth::attempt (['email'=>$data['email'],'password'=>$data['password'],'role'=>"apprenant",]))
            {
                //Session::put('adminSession',$data['email']);
                //echo "Success";die;
                return redirect('apprenant/index');

            }

        }

            return redirect('apprenant/login')->with('warning','OoOps !! Veuillez vérifier vos informations');
        }
